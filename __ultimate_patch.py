...
if "from execution.add_case_update import add_case_update as doe_add_case_update" not in app:
    if "import os, csv, json, datetime, requests, html, uuid" in app:
        app = app.replace(
...
'''
    if old not in app:
        raise SystemExit("Could not find task_items block in app.py.")
...
print("PATCH VERIFIED: app.py has form, route, loader, display list, and execution call.")
